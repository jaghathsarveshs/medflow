  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 px-4 py-12 flex items-center justify-center">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center space-y-6 shadow-2xl">
        <div className="w-16 h-16 bg-slate-800 border border-slate-700 text-emerald-400 rounded-2xl mx-auto flex items-center justify-center text-3xl font-black shadow-lg">
          👨‍⚕️
        </div>

        <div className="space-y-2">
          <span className="text-xs uppercase font-extrabold tracking-widest text-emerald-400">Doctor Portal</span>
          <h1 className="text-2xl font-black text-white">Physician Coverage Dashboard</h1>
          <p className="text-sm text-slate-400 leading-relaxed">
            On-duty doctor rosters, specialty coverage schedules, and real-time availability tracking.
          </p>
        </div>
